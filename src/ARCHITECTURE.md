...
### Product
В модуле Product создана модель продуктов с минимальным количеством полей, а так же CRUD методы реализованые с использованием Actions
...
```
## Transformers
Для одинакового формата вывода данных, модули используют трансформеры. В корне проекта находится абстрактный класс трансформера, в котором можно размешать общие методы для всех трансформеров в проекте, например метод для каста валюты передв выводом
